        ...
        <div class="main_features">
          <ul>
            ...
            <li> <i class="fa fa-cogs" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result->BikeType);?></h5>
              <p>BikeType</p>
            </li>
...
<?php
$bid=$_SESSION['brndid'];
$sql="SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.BikeType,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesBrand=:bid";
$query = $dbh -> prepare($sql);
          ...
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> seats</li>
                ...
                <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->BikeType);?></li>
              </ul>
            </div>
          </div>
        </div>
